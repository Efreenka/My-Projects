# https://www.youtube.com/watch?v=v_GzR6VPmmI&list=PLQ8x_VWW6AkuPXuUJ-lGH2aoL4vuoQg62&index=33
...
while True:
    ...
    if head.xcor() > 290 or head.xcor() < -290 or head.ycor() > 290 or head.ycor() < -290:
        ...
        # Skryjeme části těla při názazu
    ...
    # Kolize hlavy s jablkem - had sní jídlo
